...
<li class="nav-item has-treeview">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item ">
            <router-link :to="{name:'brigades'}" class="nav-link">
...
<li class="nav-item has-treeview">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item ">
            <router-link :to="{name:'configuration'}" class="nav-link">
                <i class="nav-icon fas fa-tools"></i>
                <p>
                    الإعدادات
                </p>
        ...
        <li class="nav-item ">
            <router-link :to="{name:'communes'}" class="nav-link">
        ...
        <li class="nav-item ">
            <router-link :to="{name:'exercices'}" class="nav-link">

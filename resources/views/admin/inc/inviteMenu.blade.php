<li class="nav-item has-treeview">
    ...
    <ul class="nav nav-treeview">
        <li class="nav-item">
            <router-link :to="{name:'commercants'}" class="nav-link disabled">
                <i class="nav-icon fas fa-user-cog"></i>
                <p>
                    التاجر
                </p>
        ...
        <li class="nav-item">
            <router-link  :to="{name:'activites'}" class="nav-link disabled">
...
<li class="nav-item has-treeview">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item ">
            <router-link  :to="{name:'infractions'}" class="nav-link disabled">
        ...
        <li class="nav-item ">
            <router-link :to="{name:'model_redaction'}" class="nav-link disabled">
...
<ul class="nav nav-treeview">
    ...
    <li class="nav-item ">
        <router-link :to="{name:'tsaisies'}" class="nav-link disabled">
            <i class="nav-icon fas fa-cubes"></i>
            <p>
                الحجز
            </p>
    ...
    <li class="nav-item ">
        <router-link :to="{name:'products'}" class="nav-link disabled">
    ...
    <li class="nav-item ">
        <router-link :to="{name:'categories'}" class="nav-link disabled">
    ...
    <li class="nav-item ">
        <router-link :to="{name:'typesaisies'}" class="nav-link disabled">

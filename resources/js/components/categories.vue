          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">أنواع المواد</h3>
                      ...
                      <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a v-if="gate.isAdmin() || gate.isChef() || gate.isAgent()" class="dropdown-item"  href="" @click.prevent="edit(category)"><i class="fa fa-edit"></i></a>
                                <a v-if="gate.isAdmin()" class="dropdown-item"  href="" @click.prevent="remove(category.id)"><i class="fa fa-trash"></i></a>
                            </div>
                        </div>
                      </td>
                    </tr>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                      ...
                      <input v-if="errors.category" type="text" class="form-control is-invalid" v-model="category" placeholder="اسم النوع">
                      <input v-else type="text" class="form-control" v-model="category" placeholder="اسم النوع">
...
<script>
    export default {
        ...
        methods:{
            ...
            update:function(){
                axios.put('categories/'+this.id_update,
            ...
            searching:function(){
                if(!this.search){
                    ...
                    axios.get('categories/search/'+this.search
